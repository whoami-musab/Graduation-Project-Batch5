    ...
    return (
        ...
        >
            <div className='relative main-div'>
                ...
                <div
                    className={`bg-linear-to-r from-[#d4145a] via-gray-800 to-gray-900 relative p-8 rounded-3xl shadow-lg w-full border-l-2 border-b border-[#d4145a]`}
                    style={{
                ...
                >
                    ...
                    >
                        ...
                        <Link href="/auth/register" className="text-[#d4145a] mt-4 block text-center hover:underline text-xl">
